        ...
        if results.empty:
            ...
            for idx, row in results.iterrows():
                ...
                with col2:
                    ...
                    col_p, col_r, col_a = st.columns([2, 2, 2.5])
                    with col_p:
                        if mrp_display:
                ...
                # Inline expander: clicking this expands details right here,
                # under this exact product card, instead of jumping to the
                # bottom of the page after all 20 results.
                with st.expander("📄 View Product Details"):
                    p = row
                    p_idx = search_engine.df[search_engine.df['uniq_id'] == row['uniq_id']].index[0]
                    ...
                    with det_col2:
                        ...
                        if not labeled_revs:
                            st.warning("⚠️ No reviews could be loaded for this product. "
                                       "This usually means the reviews dataset didn't load correctly — "
