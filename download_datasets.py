...
def generate_synthetic_amazon_catalog(output_path="data/amazon_products.csv", n=5000):
...
def download_fake_reviews(output_path="data/fake_reviews.csv"):
...
def download_amazon_catalog(output_path="data/amazon_products.csv"):
