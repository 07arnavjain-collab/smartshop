...
PROCESSED_DATA_PATH = "data/processed_products.pkl"
...
class SmartShopSearch:
    ...
    def load_and_preprocess_catalog(self, raw_path="data/amazon_products.csv"):
...
class ReviewAssociator:
    def __init__(self, fake_reviews_path="data/fake_reviews.csv"):
        self.fake_reviews_path = fake_reviews_path
